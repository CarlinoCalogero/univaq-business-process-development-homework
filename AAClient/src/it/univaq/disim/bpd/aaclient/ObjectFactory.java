 ...
 * generated in the it.univaq.disim.bpd.aaclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _FlightTicketResponse_QNAME = new QName("http://aaservice.bpd.disim.univaq.it/", "flightTicketResponse");
    private final static QName _FlightTicket_QNAME = new QName("http://aaservice.bpd.disim.univaq.it/", "flightTicket");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.univaq.disim.bpd.aaclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://aaservice.bpd.disim.univaq.it/", name = "flightTicketResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://aaservice.bpd.disim.univaq.it/", name = "flightTicket")
